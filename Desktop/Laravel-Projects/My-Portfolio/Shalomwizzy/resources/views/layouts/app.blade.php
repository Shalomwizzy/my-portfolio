...
<head>
    ...
    <script src="https://kit.fontawesome.com/cc71075486.js" crossorigin="anonymous"></script>
      ...
      {{-- LOGO --}}
      <link rel="shortcut icon" href="{{ asset('images/my classic photo.JPG') }}">
...
<script class="weglot-language">
    ...
    <!-- Scripts -->
    @vite(['resources/sass/app.scss', 'resources/js/app.js','resources/js/mode.js','resources/js/welcome.js','resources/css/nav.css','resources/css/mode.css','resources/css/app.css','resources/css/welcome.css','resources/css/projects.css','resources/css/skills.css','resources/css/learning.css','resources/css/contact-me.css',])
    ...
    /* .thank-you-container{
        background-image: url('{{ asset("images/thankyou-image2.jpg") }}') !important;
        background-size: contain;
        background-position: center;
    }  */

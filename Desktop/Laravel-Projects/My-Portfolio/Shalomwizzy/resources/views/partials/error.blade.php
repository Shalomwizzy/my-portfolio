...
@if ($message = Session::get('success'))
    <div class="alert rounded-0 animate__animated animate__fadeInRight alert-dismissible fade show position-fixed top-0 end-0" role="alert" style="z-index: 999; top: 25%; right: 10px;  background-color: green;">
        <strong>{{ $message }}</strong>
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div> 
@endif
